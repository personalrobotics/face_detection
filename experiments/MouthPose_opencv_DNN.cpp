...
// }
//
// vector<rectangle> detectFaceOpenCVDNN(Net net, Mat &frameOpenCVDNN)
// {
...
//
//             facesAboveThreshold.push_back(cv::rectangle(frameOpenCVDNN, cv::Point(x1, y1), cv::Point(x2, y2), cv::Scalar(0, 255, 0),2, 4));
//         }
//     }
